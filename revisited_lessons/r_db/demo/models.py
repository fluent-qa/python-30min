...
class Manufacturer(BaseEntityModel):
...
class OrderItem(BaseEntityModel):
...
class ProductReview(BaseEntityModel):
...
class BlogArticle(BaseEntityModel):
...
class BlogAuthor(BaseEntityModel):
...
class BlogUser(BaseEntityModel):
...
class BlogSession(BaseEntityModel):
...
class BlogView(BaseEntityModel):
...
class Language(BaseEntityModel):
